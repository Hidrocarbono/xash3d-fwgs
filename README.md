...
0) Get Xash3D FWGS binaries: you can use [testing](https://github.com/Hidrocarbono/xash3d-fwgs/releases/tag/continuous) build or you can compile engine from source code.
...
* Clone this repository: `git clone --recursive https://github.com/Hidrocarbono/xash3d-fwgs`.
...
* Clone this repostory: `$ git clone --recursive https://github.com/Hidrocarbono/xash3d-fwgs`.
